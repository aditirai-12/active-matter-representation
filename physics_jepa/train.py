                ...
                if i % self.train_cfg.report_every == 0:
                    ...
                    if self.rank == 0:
                        ...
                        if i > 0:
                            ...
                            mins_per_step = elapsed_minutes / self.train_cfg.report_every
                            eta_minutes = remaining_steps * mins_per_step
                            distprint(f"ETA: {eta_minutes:.2f} min remaining", local_rank=self.rank)
                        start_time = datetime.datetime.now()
